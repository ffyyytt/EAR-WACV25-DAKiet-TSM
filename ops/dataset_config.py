...
def return_elderly(modality):
    filename_categories = 'data/classInd.txt'
    root_data = 'data/train_img'
    filename_imglist_train = 'data/train_img/train.txt'
    filename_imglist_val = 'data/train_img/val.txt'
    prefix = '{:06d}.jpg'
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'elderly': return_elderly }
